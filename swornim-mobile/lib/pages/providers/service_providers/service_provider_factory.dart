...
class ServiceProviderFactory {
  ...
  static Map<String, dynamic> _normalizeJson(Map<String, dynamic> json) {
    ...
    final listFields = [
      ...
      'gallery', 'services', 'cuisine_types', 'service_types', 'event_types'
    ];
  ...
  static List<String> validateProvider(ServiceProvider provider) {
    ...
    if (provider is MakeupArtist) {
      ...
      if (provider.address.trim().isEmpty) {
      ...
      if (provider.contactPhone.trim().isEmpty) {
        errors.add('Contact phone is required');
      }
      if (provider.contactEmail.trim().isEmpty) {
